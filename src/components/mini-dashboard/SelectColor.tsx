...
export const SelectColor = () => {
    return (
        <div className='m-3 p-6 bg-white bg-opacity-20 rounded-[16px] shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-[5px] webkit-backdrop-blur-[5px] border border-solid border-[rgba(255,255,255,0.3)]'>
