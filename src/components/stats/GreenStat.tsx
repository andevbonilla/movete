...
export const GreenStat = ({ NumReps, ExerciseType, Weight, metric }: StatInterface) => {

    return (
        <div className={`flex items-center justify-between mx-8 py-4 px-5 bg-[#00FF8F] rounded-lg mb-5`}>
