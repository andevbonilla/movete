...
export const BlueStat = ({ NumReps, ExerciseType, Weight, metric }: StatInterface) => {

    return (
        <div className={`flex items-center justify-between mx-8 py-4 px-5 bg-blue-500 rounded-lg mb-5`}>
