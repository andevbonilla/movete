...
export const ExampleProfileFour = ({ username, desc, imgUrl, bannerUrl, exercises, socialMedia }: ProfileInterface) => {

    return (
        <div className={`h-[34rem] overflow-y-scroll rounded-t-2xl bg-[#001429] text-red-500`}>
            {
                (bannerUrl === "")
